...
2. Copy this entire block, including the comment *and the empty line at the end!*
...
3. Paste it in to your Terminal. Stuff will start running. When it's done, you'll see `# DONE` at the bottom.
