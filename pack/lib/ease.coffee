...
Take "PureMath", (PureMath)->
  ...
  # These are here to make it easier to test
  # console.log Ease.cubic(0.0, 0, 1, 0, 10)
  # console.log Ease.cubic(0.1, 0, 1, 0, 10)
  # console.log Ease.cubic(0.2, 0, 1, 0, 10)
  # console.log Ease.cubic(0.3, 0, 1, 0, 10)
  # console.log Ease.cubic(0.4, 0, 1, 0, 10)
  # console.log Ease.cubic(0.5, 0, 1, 0, 10)
  # console.log Ease.cubic(0.6, 0, 1, 0, 10)
  # console.log Ease.cubic(0.7, 0, 1, 0, 10)
  # console.log Ease.cubic(0.8, 0, 1, 0, 10)
  # console.log Ease.cubic(0.9, 0, 1, 0, 10)
  # console.log Ease.cubic(1.0, 0, 1, 0, 10)
